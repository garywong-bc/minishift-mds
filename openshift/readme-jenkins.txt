...
oc process -f _jenkins.bc.json -l app=jenkins | oc apply -f - -n minishift-mds-tools
oc process -f _jenkins.dc.json -l app=jenkins | oc apply -f - -n minishift-mds-tools
